...
export function initVuelos() {
    ...
    const contenedor = document.getElementById("vuelos-resultados");
    ...
    contenedor.innerHTML = ""; // mismo comportamiento que hoteles
    ...
    vuelos.forEach(vuelo => {
        ...
        card.className =
            'bg-white border border-blue-100 rounded-xl p-6 shadow-md hover:shadow-xl transition flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-4';
